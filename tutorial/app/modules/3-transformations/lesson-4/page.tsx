...
export default function Lesson3_4Page() {
  ...
  return (
    ...
    return row`} language="python" showLineNumbers showCopyButton />
        ...
        <NavigationButtons nextUrl="/modules/3-transformations/lesson-5" nextLabel="Next: Testing"
          previousUrl="/modules/3-transformations/lesson-3" previousLabel="Back: Validation" onComplete={handleComplete} />
      </div>
    </LessonLayout>
  );
}
