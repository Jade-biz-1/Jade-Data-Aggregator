...
def transform(data):
    ...
    return data`}
        ...
        <NavigationButtons nextUrl="/modules/3/exercise" nextLabel="Start Exercise"
          previousUrl="/modules/3/lesson-4" previousLabel="Back: Custom Functions" onComplete={handleComplete} />
      </div>
    </LessonLayout>
  );
}
