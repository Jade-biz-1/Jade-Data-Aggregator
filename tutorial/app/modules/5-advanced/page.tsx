  ...
  const lessons = [
    {
      ...
      duration: '25 min',
      difficulty: 'Advanced',
      url: '/modules/5-advanced/lesson-1',
    ...
    },
    {
      ...
      duration: '30 min',
      difficulty: 'Advanced',
      url: '/modules/5-advanced/lesson-2',
    ...
    },
    {
      ...
      duration: '25 min',
      difficulty: 'Advanced',
      url: '/modules/5-advanced/lesson-3',
    ...
    },
    {
      ...
      url: '/modules/5-advanced/lesson-4',
    ...
    },
    {
      ...
      duration: '30 min',
      difficulty: 'Advanced',
      url: '/modules/5-advanced/lesson-5',
        ...
        <Card className="p-8 bg-gradient-to-r from-purple-50 to-pink-50 border-purple-200">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <Link href="/modules/5-advanced/exercise">
