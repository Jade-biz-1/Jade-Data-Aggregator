...
result = breaker.call(external_api.fetch_data)`} language="python" showLineNumbers showCopyButton />
        ...
        <NavigationButtons previousUrl="/modules/5-advanced/lesson-2" previousLabel="Back: Monitoring"
          nextUrl="/modules/5-advanced/lesson-4" nextLabel="Next: Pipeline Templates" onComplete={handleComplete} />
      </div>
    </LessonLayout>
  );
}
