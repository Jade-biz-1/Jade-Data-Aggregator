...
export default function Lesson5Page() {
  ...
  return (
    <LessonLayout
      title="Destination Connector Setup"
      description="Learn how to configure destination connectors and choose the right write modes"
      module="Module 4: Data Pipelines"
      lessonNumber={5}
      estimatedTime="18 min"
      difficulty="intermediate"
      objectives={[
        'Configure database destination connectors',
        'Choose appropriate write modes (append, replace, upsert)',
        'Set up table schemas and indexes',
        'Apply destination configuration best practices',
      ]}
    >
  ...
  "destination": {
    ...
    "config": {
      ...
      "on_error": "skip_row"
        ...
        <NavigationButtons
          previousUrl="/modules/4/lesson-4"
          nextUrl="/modules/4/lesson-6"
