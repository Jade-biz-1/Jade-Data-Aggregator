...
export default function Lesson8Page() {
  ...
  return (
    <LessonLayout
      ...
      description="Learn how to monitor pipeline performance and set up alerts for issues"
      ...
      objectives={[
        ...
        'Configure alerts for failures and issues',
        'Review execution logs and troubleshooting',
  ...
  "quality_checks": [
    ...
    },
    {
      ...
      "action": "alert"
        ...
        <NavigationButtons
          previousUrl="/modules/4/lesson-7"
          nextUrl="/modules/4/exercise"
