...
export default function Lesson6Page() {
  ...
  return (
    <LessonLayout
      ...
      description="Learn how to schedule pipeline execution with cron expressions and intervals"
      ...
      objectives={[
        ...
        'Set up interval-based schedules',
        'Understand manual trigger options',
        'Apply scheduling best practices',
      ]}
    >
  ...
  "schedule": {
    ...
    "advanced": {
      ...
      "notifications": {
        ...
        <NavigationButtons
          previousUrl="/modules/4/lesson-5"
          nextUrl="/modules/4/lesson-7"
