...
export default function Lesson7Page() {
  ...
  return (
    <LessonLayout
      ...
      description="Learn how to run pipelines manually, via API, and monitor execution status"
      module="Module 4: Data Pipelines"
      lessonNumber={7}
      estimatedTime="20 min"
      difficulty="intermediate"
      objectives={[
        'Execute pipelines manually and via API',
...
curl -X POST https://api.platform.com/v1/pipelines/run \\
  ...
  "on_row_error": {
    ...
    "max_error_rate": 0.05
        ...
        <NavigationButtons
          previousUrl="/modules/4/lesson-6"
          nextUrl="/modules/4/lesson-8"
