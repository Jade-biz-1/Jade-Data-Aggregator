...
export default function Lesson2Page() {
  ...
  return (
    <LessonLayout
      ...
      description="Learn how to use the drag-and-drop interface to create data pipelines"
      module="Module 4: Data Pipelines"
      lessonNumber={2}
      estimatedTime="20 min"
      difficulty="intermediate"
      objectives={[
        'Understand the visual pipeline builder interface',
        'Learn to add and configure pipeline components',
        'Explore drag-and-drop functionality',
        'Configure source, transform, and destination steps',
      ]}
    >
      <div className="space-y-8">
        ...
        <NavigationButtons
          previousUrl="/modules/4/lesson-1"
          nextUrl="/modules/4/lesson-3"
