...
export default function Lesson1Page() {
  ...
  return (
    <LessonLayout
      ...
      description="Learn the fundamental concepts of data pipeline architecture and design patterns"
      module="Module 4: Data Pipelines"
      lessonNumber={1}
      estimatedTime="15 min"
      difficulty="intermediate"
      objectives={[
        'Understand pipeline architecture concepts',
        'Learn about data flow patterns',
        'Explore pipeline components and their roles',
        'Design basic pipeline structures',
      ]}
    >
  ...
  "schedule": {
    ...
    "timezone": "UTC"
        ...
        <NavigationButtons
          previousUrl="/modules/4"
          nextUrl="/modules/4/lesson-2"
