  ...
  const scenarios = [
    {
      ...
      duration: '45 min',
      url: '/modules/6-scenarios/scenario-1',
    ...
    },
    {
      ...
      difficulty: 'Advanced',
      duration: '60 min',
      url: '/modules/6-scenarios/scenario-2',
    ...
    },
    {
      ...
      difficulty: 'Advanced',
      duration: '50 min',
      url: '/modules/6-scenarios/scenario-3',
    ...
    },
    {
      ...
      difficulty: 'Advanced',
      duration: '55 min',
      url: '/modules/6-scenarios/scenario-4',
        ...
        <Card className="p-8 bg-gradient-to-r from-yellow-50 to-orange-50 border-yellow-200">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <Link href="/modules/6-scenarios/capstone">
