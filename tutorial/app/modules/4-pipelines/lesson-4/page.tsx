...
export default function Lesson4Page() {
  ...
  return (
    <LessonLayout
      ...
      lessonTitle="Lesson 4.4: Adding Transformation Steps"
      lessonId="module-4-lesson-4"
    >
  ...
  "config": {
    ...
    return row`} />
        ...
        <NavigationButtons
          previousHref="/modules/4-pipelines/lesson-3"
          nextHref="/modules/4-pipelines/lesson-5"
