...
export default function Lesson3Page() {
  ...
  return (
    <LessonLayout
      ...
      lessonTitle="Lesson 4.3: Source Connector Configuration"
      lessonId="module-4-lesson-3"
    >
  ...
  "source": {
    ...
    "config": {
      ...
      "parameters": {
        ...
        <NavigationButtons
          previousHref="/modules/4-pipelines/lesson-2"
          nextHref="/modules/4-pipelines/lesson-4"
