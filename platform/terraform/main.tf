...
provider "aws" {
  ...
  # Make it faster by skipping some requests
  skip_requesting_account_id = true
  skip_metadata_api_check    = true
  skip_credentials_validation = true  # Only for initial setup
}
...
resource "aws_db_instance" "dataaggregator_db" {
...
resource "aws_security_group" "rds" {
  ...
  ingress {
    ...
    # For now, allow access from ECS cluster security group
    # In production, use specific security groups
...
resource "aws_lb_listener" "https" {
  ...
  default_action {
    ...
    fixed_response {
      ...
      message_body = "Not Found: Path not configured"
      status_code  = "404"
    }
  }
}
